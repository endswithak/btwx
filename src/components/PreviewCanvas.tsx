    ...
    tweenEvents.allIds.forEach((eventId) => {
      ...
      Object.keys(tweenEventTweensById).forEach((tweenId) => {
        ...
        previewUtils.addTweens({
          ...
          originPaperLayer: tweenLayers.byId[tween.layer].type === 'Text' ? paperTweenLayersById[tween.layer].getItem({data: {id: 'textContent'}}) : paperTweenLayersById[tween.layer],
          destinationPaperLayer: tweenLayerDestinations.byId[tween.destinationLayer].type === 'Text' ? paperTweenLayerDestinationsById[tween.destinationLayer].getItem({data: {id: 'textContent'}}) : paperTweenLayerDestinationsById[tween.destinationLayer],
