...
import { setLayersScrambleTextTweenDelimiter } from '../store/actions/layer';
import { getSelectedScrambleTextTweensDelimiter } from '../store/selectors/layer';
...
const EaseEditorScrambleTextDelimiterInput = (props: EaseEditorScrambleTextDelimiterInputProps): ReactElement => {
  ...
  const delimiter = useSelector((state: RootState) => getSelectedScrambleTextTweensDelimiter(state));
  ...
  const handleSubmit = (e: any): void => {
    if (valid && dirty) {
      dispatch(setLayersScrambleTextTweenDelimiter({
