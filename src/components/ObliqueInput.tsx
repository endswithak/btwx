...
//       const newPointText = new paperMain.PointText({
...
//             point: new paperMain.Point(textContent.point.x, textContent.point.y + (i * textContent.leading)),
//             content: textContent._lines[i],
//             style: textContent.style,
//             parent: paperLayer,
//             data: { id: 'textLine', type: 'LayerChild', layerType: 'Text' }
//           });
//           newLine.skew(new paperMain.Point(-e.target.value, 0));
//         }
//       }
//       // newPointText.skew(new paperMain.Point(-e.target.value, 0));
//       // textLines.removeChildren();
//       // (newPointText as any)._lines.reduce((result: paper.PointText[], current: string, index: number) => {
//       //   const line = new paperMain.PointText({
//       //     point: new paperMain.Point(newPointText.point.x, newPointText.point.y + (index * newPointText.leading)),
//       //     content: current,
