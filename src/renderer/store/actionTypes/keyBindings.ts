...
export const RESET_ALL_KEY_BINDINGS = 'RESET_ALL_KEY_BINDINGS';

export const HYDRATE_KEY_BINDINGS = 'HYDRATE_KEY_BINDINGS';
...
export interface ResetAllKeyBindings {
  type: typeof RESET_ALL_KEY_BINDINGS;
  payload: KeyBindingsState;
}

export interface HydrateKeyBindings {
  type: typeof HYDRATE_KEY_BINDINGS;
  payload: KeyBindingsState;
}
